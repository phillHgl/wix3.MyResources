...
call "%_msbuild%" ..\..\wix3\Wix.proj /t:Rebuild  /p:DebugSymbols=true /p:DebugType=full /p:Optimize=false /v:diag /l:FileLogger,Microsoft.Build.Engine;logfile="%~dp0\wix3.log"
