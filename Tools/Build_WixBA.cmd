...
call "%_msbuild%" ..\..\wix3\src\Setup\WixBA\WixBA.csproj /m:1 /p:DebugSymbols=true /p:DebugType=full /p:Optimize=false /v:normal /l:FileLogger,Microsoft.Build.Engine;logfile="%~dp0\WixBA.log"
